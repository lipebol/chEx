...
def alertCustomer():
    ...
    window_alertCustomer = sg.Window("chEx",icon='files_app/images/chEx-icon.ico', 
    layout = layout_alertCustomer, size=(320, 100), resizable = True, element_justification='c', 
    finalize=True)
...
def confirmInsertCustomer():
    ...
    window_confirmInsertCustomer = sg.Window("chEx",icon='files_app/images/chEx-icon.ico', 
    layout = layout_confirmInsertCustomer, size=(250, 100), resizable = True, 
...
def newCustomer():
    ...
    window_newCustomer = sg.Window("chEx", icon='files_app/images/chEx-icon.ico',
    layout = layout_newCustomer, size=(460, 620), resizable = True, element_justification='c', 
    finalize=True)
