...
def alertEmpty():
    ...
    window_alertEmpty = sg.Window("chEx",icon='files_app/images/chEx-icon.ico', 
    layout = layout_alertEmpty, size=(388, 130), resizable = True, element_justification='c', 
    finalize=True)
...
def confirmGenerateCSVAndExcel():
    ...
    window_confirmGenerateCSVAndExcel = sg.Window("chEx",icon='files_app/images/chEx-icon.ico', 
    layout = layout_confirmGenerateCSVAndExcel, size=(388, 130), resizable = True, 
