...
def dataFrameCustomers():
    ...
    window_dataFrameCustomers = sg.Window("chEx", icon='files_app/images/chEx-icon.ico', 
    layout = layout_dataFrameCustomers, size=(400, 260), resizable=True, element_justification='c', 
    finalize=True)
