...
def dataFramePlans():
    ...
    dataFrame = pd.read_sql_query("SELECT Id, Tipo, Modalidade, Valor FROM Planos", conn)
    ...
    window_dataFramePlans = sg.Window("chEx", icon='files_app/images/chEx-icon.png', 
    layout = layout_dataFramePlans, size=(400, 240), resizable=True, element_justification='c', 
    finalize=True)
