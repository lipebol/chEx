...
def alertPlan():
    ...
    window_alertPlan = sg.Window("chEx",icon='files_app/images/chEx-icon.png', 
    layout = layout_alertPlan, size=(320,80), resizable = True, element_justification='c', 
    finalize=True)
...
def confirmInsertPlan():
    ...
    window_confirmInsertPlan = sg.Window("chEx",icon='files_app/images/chEx-icon.png', 
    layout = layout_confirmInsertPlan, size=(250,80), resizable = True, element_justification='c', 
    finalize=True)
...
def newPlan():
    ...
    window_newPlan = sg.Window("chEx", icon='files_app/images/chEx-icon.png',
    layout = layout_newPlan, size=(400, 566), resizable = True, finalize=True)
